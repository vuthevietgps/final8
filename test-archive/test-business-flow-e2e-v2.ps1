...
if ($script:testResults["sp_stmt1_id"]) {
    $body = @{ amount=500000; paidAt="2026-02-15T10:00:00.000Z"; method="bank_transfer"; reference="TXN-S1-001"; notes="E2E" } | ConvertTo-Json
...
if ($script:testResults["sp_stmt2_id"]) {
    $body = @{ amount=400000; paidAt="2026-02-15T11:00:00.000Z"; method="bank_transfer"; reference="TXN-S2-001"; notes="E2E" } | ConvertTo-Json
...
if ($script:testResults["ag_stmt1_id"]) {
    $body = @{ amount=200000; paidAt="2026-02-15T12:00:00.000Z"; method="bank_transfer"; reference="TXN-AG1-001"; notes="E2E" } | ConvertTo-Json
...
if ($script:testResults["ag_stmt2_id"]) {
    $body = @{ amount=150000; paidAt="2026-02-15T13:00:00.000Z"; method="bank_transfer"; reference="TXN-AG2-001"; notes="E2E" } | ConvertTo-Json
