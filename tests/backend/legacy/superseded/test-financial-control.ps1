...
$fcServicePath = Join-Path $RepoRoot "backend/src/finance/financial-control.service.ts"
$cashflowDashboardPath = Join-Path $RepoRoot "backend/src/cashflow-control/services/dashboard.service.ts"
