...
let UserController = class UserController {
    ...
    getActiveAgentsMinimal() {
        return this.userService.findActiveAgentsMinimal([user_enum_1.UserRole.INTERNAL_AGENT, user_enum_1.UserRole.EXTERNAL_AGENT]);
    }
    getSuppliers(q, active, minimal) {
...
__decorate([
    (0, common_1.Post)(),
    (0, auth_decorator_1.RequirePermissions)('users'),
...
__decorate([
    ...
    (0, auth_decorator_1.RequirePermissions)('orders'),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], UserController.prototype, "getActiveAgentsMinimal", null);
__decorate([
    (0, common_1.Get)('suppliers'),
    (0, auth_decorator_1.RequirePermissions)('users'),
    __param(0, (0, common_1.Query)('q')),
    __param(1, (0, common_1.Query)('active')),
    __param(2, (0, common_1.Query)('minimal')),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String]),
    __metadata("design:returntype", void 0)
], UserController.prototype, "getSuppliers", null);
__decorate([
    (0, common_1.Get)(':id'),
    (0, auth_decorator_1.RequirePermissions)('users'),
