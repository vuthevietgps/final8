...
<#
    =====================================================================================
    TEST-MODULE-FINANCIAL-DEEP.ps1
    =====================================================================================
    Deep test for Financial modules:
    Phase 0: Login
...
if ($fcDebug -ne $null) { Write-Pass "FC debug deprecation-stats OK" } else { Write-Fail "FC debug failed" }

# ===== PHASE 2: BUDGET ALLOCATION =====
Write-Section "PHASE 2: Budget Allocation"

Write-Step "2.1" "Get allocation status"
$baStatus = Safe-Request -Method GET -Uri "$BaseUrl/budget-allocation/status" -Headers @{} -Label "BaStatus"
...
$baPreview = Safe-Request -Method GET -Uri "$BaseUrl/budget-allocation/preview?priorityMode=roi" -Headers @{} -Label "BaPreview"
